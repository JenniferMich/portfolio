    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <motion.div initial={{opacity:0, scale:0.5}} animate={{opacity:1, scale:1}} transition={{duration:0.5}}className="col-span-8 place-self-center text-center sm:text-left justify-self-start ">
          ...
          <div>
            <a
              href="/images/projects/cursos_merged.pdf" // Ruta al archivo PDF de la documentación
              download="documentation.pdf" // Nombre del archivo que se descargará
            ...
            <a
              href="/images/projects/CVenglishversion.pdf" // Ruta al archivo PDF del CV
              download="CVenglishversion.pdf" // Nombre del archivo que se descargará
            ...
            <a
              href="/images/projects/CVE.pdf" // Ruta al archivo PDF del CV
              download="Currículum Vitae JMCL.pdf" // Nombre del archivo que se descargará
